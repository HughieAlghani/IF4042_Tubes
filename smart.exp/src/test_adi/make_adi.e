...
$bin/smart convert $database/spec   proc convert.obj.weight_query \
                   in query.nnn  out query.ltu   query_weight lts
$bin/smart convert $database/spec   proc convert.obj.weight_query \
                   in query.nnn  out query.dtn   query_weight btn
...
$bin/smart convert $database/spec   proc convert.obj.weight_doc \
                   in doc.nnn  out doc.Lnu   doc_weight sns
$bin/smart convert $database/spec   proc convert.obj.vec_aux  \
                   in doc.Lnu  out inv.Lnu
$bin/smart convert $database/spec   proc convert.obj.weight_doc \
                   in doc.nnn  out doc.dnu   doc_weight bns
$bin/smart convert $database/spec   proc convert.obj.vec_aux  \
                   in doc.dnu  out inv.dnu
